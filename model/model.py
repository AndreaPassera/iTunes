...
class Model:
    ...
    def buildGraph(self,durataMin):
        ...
        self._idMap={n.AlbumId: n for n in self._allNodi}
    ...
    def getSetOfNodes(self,a1, soglia):
        ...
        parziale={a1}
        cc=nx.node_connected_component(self._grafo,a1)
        cc.remove(a1) #non ha senso lasciarla nella componente connessa perchè lho già inserito a1

        for n in cc:
            #richiamo la ricorsione
            parziale.add(n) #non append perchè  un set
    ...
    def _ricorsione(self,parziale, rimanenti, soglia):
        ...
        #2 se parziale soddisfa i criteri, verifico se è migliore di bestSet (non è una condizione di terminazione)
